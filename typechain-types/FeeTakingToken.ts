...
export interface FeeTakingTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FEE_PERCENT"
      | "ZERO_ADDRESS"
...
export interface FeeTakingToken extends BaseContract {
  connect(runner?: ContractRunner | null): FeeTakingToken;
  waitForDeployment(): Promise<this>;

  interface: FeeTakingTokenInterface;
